...
export class AddPost extends React.Component{
    ...
    sendForm(event){
       ...
       fetch('http://skipkris7.beget.tech/SPA/php/addPost.php',{
           method: 'POST',
           body: formData
...
handleInputChange(event){
        ...
        if (name === "title"){
            ...
            fetch("http://skipkris7.beget.tech/SPA/php/checkTitle.php",{
            method: 'POST',
            body: formData
            }).then(response=>response.json())
                .then(result=>{
    ...
    render(){
        return <div className="col-md-5 my-5 mx-auto">
            ...
            <form onSubmit={this.sendForm}>
                ...
                <div className="mb-3">
                    <input value={this.state.author} onChange={this.handleInputChange} name="author" type="" className="form-control" placeholder="author"/>
                </div>
                <div className="mb-3">
